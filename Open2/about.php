            ...
            <nav class="navbar navbar-dark navbar-expand-lg py-0">
                ...
                <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                    <div class="navbar-nav ms-auto mx-xl-auto p-0">
                        ...
                        <a href="about.php" class="nav-item nav-link active text-secondary">About</a>
        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="about.php">Pages</a></li>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                    <h5 class="text-primary" style="text-align: center;">Tentang Kami</h5>
                    <h1 class="mb-4" style="text-align: center;"><b>Temukan Peluang Menjadi Writer : Blogmu, Karirmu,
                            Masa Depanmu!</b></h1>
                    <p>Mencari wadah untuk menuangkan ide dan menapaki jalan menuju karir penulis yang gemilang? Tak
                        perlu menjelajah jauh, karena di sini, di blog ini, kamu akan menemukan samudra penuh peluang
                        untuk berkembang dan meraih mimpimu!

                        Kami bukan sekadar platform blog biasa, melainkan rumah bagi para penulis yang ingin mengasah
                        kemampuan, membangun komunitas, dan mengukir nama mereka di dunia digital. Di sini,
                        karya-karyamu akan dibaca oleh para pembaca yang haus akan konten inspiratif dan informatif,
                        membuka gerbang menuju pengakuan dan kesuksesan.</p>
                    <p class="mb-4">Kami bukan sekadar platform blog biasa, melainkan rumah bagi para penulis yang ingin
                        mengasah kemampuan, membangun komunitas, dan mengukir nama mereka di dunia digital. Di sini,
                        karya-karyamu akan dibaca oleh para pembaca yang haus akan konten inspiratif dan informatif,
                        membuka gerbang menuju pengakuan dan kesuksesan.</p>
                </div>
            </div>
    ...
    <div class="container-fluid py-5 my-5">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="h-100 position-relative">
                        <img src="img/p.jpeg" class="img-fluid w-75 rounded" alt="" style="margin-bottom: 25%;">
                        <div class="position-absolute w-75" style="top: 25%; left: 25%;">
                            <img src="img/pe.jpeg" class="img-fluid w-100 rounded" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                    <h1 class="mb-4" style="text-align: center;"><b>Mengapa memilih blog kami?</b>
                    </h1>

                    <p class="mb-4">1. Komunitas yang suportif: Bergabunglah dengan komunitas penulis yang saling
                        mendukung dan
                        menginspirasi.</p>

                    <p class="mb-4">2. Peluang untuk berkembang: Temukan berbagai sumber daya dan panduan untuk
                        meningkatkan kemampuan
                        menulismu.</p>
                    <p class="mb-4">3. Jangkauan yang luas: Bagikan karyamu kepada pembaca dari seluruh dunia dan bangun
                        pengikut
                        setia.</p>
                    <p class="mb-4">4. Peluang monetisasi: Dapatkan penghasilan dari tulisanmu melalui berbagai program
                        monetisasi.</p>
                    <a href="../Open/login.php" class="btn btn-secondary rounded-pill px-5 py-3 text-white">Siapkah kamu
                        untuk menjadi salah satu seperti kami?</a>
