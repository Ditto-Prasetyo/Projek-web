            ...
            <nav class="navbar navbar-dark navbar-expand-lg py-0">
                ...
                <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                    <div class="navbar-nav ms-auto mx-xl-auto p-0">
                        ...
                        <a href="contact.php" class="nav-item nav-link active text-secondary">Kontak</a>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                ...
                                <a href="https://www.google.com/maps/place/Universitas+Islam+Negeri+Maulana+Malik+Ibrahim+Malang/@-7.9510684,112.6048342,17z/data=!3m1!4b1!4m6!3m5!1s0x2e78815e45bbc56d:0x5031ab2d7d36dba6!8m2!3d-7.9510737!4d112.6074091!16s%2Fg%2F1hc1tl5vp?entry=ttu"
                                    target="_blank" class="h5">UIN Maulana Malik Ibrahim Malang</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                ...
                                <a class="h5" href="mailto:info@uin-malang.ac.id"
                                    target="_blank">info@uin-malang.ac.id</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="mt-4 d-flex flex-column help-link">
                        <a href="termsandpolicy.php" class="mb-2 text-white"><i
                                class="fas fa-angle-right text-secondary me-2"></i>Terms
                            Of use</a>
                        <a href="privacyandpolicy.php" class="mb-2 text-white"><i
